...
layout: cover
class: text-center
background: images/pexels-theotherkev-3149048.jpg
---
...
* Part 2: going deep with git protocols
  * Show the git commands people typically use
  * Note the plumbing commands
  * We're going even deeper than that, to the protocols themselves
* Part 3: concurrency
* Part 4: stability
* Part 5: conclusions
